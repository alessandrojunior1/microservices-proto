...
const file_order_order_proto_rawDesc = "" +
	...
	"\border_id\x18\x01 \x01(\x05R\aorderId2H\n" +
	"\x05Order\x12?\n" +
	"\x06Create\x12\x19.order.CreateOrderRequest\x1a\x1a.order.CreateOrderResponseB?Z=github.com/alessandrojunior1/microservices-proto/golang/orderb\x06proto3"
